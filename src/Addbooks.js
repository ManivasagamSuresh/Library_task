...
return error
    ...
    onSubmit : async(value)=>{
        try{let data = await axios.post('https://63450500dcae733e8fe7f213.mockapi.io/products',value)
        alert('success')
    }
    catch(error){
        alert('error')
  ...
  <textarea class="form-control" aria-label="With textarea" name='description' onChange={formik.handleChange} value={formik.values.description}  onBlur={formik.handleBlur} ></textarea>
